---
sidebar_position: 1
description: Nebula v1.9.4 to v1.9.6 contains an issue where Nebula could incorrectly accept and process a packet from an erroneous source IP when the sender's certificate is configured with unsafe_routes.
---
