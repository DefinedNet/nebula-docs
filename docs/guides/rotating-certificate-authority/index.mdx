...
to close existing tunnels to hosts which are no longer trusted - either because their certificates are expired or
because their certificate is no longer signed by a trusted CA. This will accelerate how quickly you learn of problems
after updating your CA trust bundle, giving you as much time as possible to rollback and fix any issues before your CA
expires.
