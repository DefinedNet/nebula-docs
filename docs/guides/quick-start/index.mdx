...
Manager), it is recommended to pass the `-encrypt` flag when generating the CA. Each time you sign a host using an
encrypted CA key, you will need to re-enter your chosen password.
