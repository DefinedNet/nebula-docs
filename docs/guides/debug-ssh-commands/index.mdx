...
First you need to configure the [`sshd`](https://nebula.defined.net/docs/config/sshd/) section on the host you want to
debug.
...
You must add the correct public ssh key for the users you wish to access the ssh server with.

Next, restart nebula and ssh via `ssh 127.0.0.1 -p 2222`.
...
https://nebula.defined.net/docs/config/preferred-ranges/#how-nebula-orders-underlay-ip-addresses-it-learns-about)
