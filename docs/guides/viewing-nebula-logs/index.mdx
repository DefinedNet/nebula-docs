...
These instructions assume that you either installed Nebula using your distribution's package manager or by copying the [example systemd unit](https://github.com/slackhq/nebula/blob/master/examples/service_scripts/nebula.service) from the Github repository.
