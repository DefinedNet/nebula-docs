...
Relays are a list of Nebula IP’s that peers can use to relay packets to me. IPs in this list must have am_relay set to
true in their configs, otherwise they will reject relay requests.
