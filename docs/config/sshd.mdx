...
_Hint: To generate the host key run `ssh-keygen -t ed25519 -f ssh_host_ed25519_key`. Be sure to set the ownership appropriately, e.g. `chown root:root ssh_host_ed25519_key`_
