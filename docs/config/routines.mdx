---
sidebar_position: 12
description: Routines config section
---
...
on the tun device and `SO_REUSEPORT` on the UDP socket to allow multiple queues. This option is only supported on Linux.
