...
still, to avoid resource starvation.

When set above `1`, the reader threads are pinned to CPUs by default; see
[`tun.pin_threads`](/docs/config/tun/#tunpin_threads) and [`tun.cpu_affinity`](/docs/config/tun/#tuncpu_affinity) to
