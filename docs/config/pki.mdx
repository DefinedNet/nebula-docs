...
`pki.initiating_version` determines which nebula cert version to use when initiating new connections. If unset, it will
default to v1 if any v1 cert is available, otherwise it will default to v2.
