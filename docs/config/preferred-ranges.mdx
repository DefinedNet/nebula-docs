...
- IP address is in `preferred_ranges` set and is [ipv6](https://en.wikipedia.org/wiki/IPv6)
- IP address is in `preferred_ranges` set and is [public ipv4](https://en.wikipedia.org/wiki/IPv4)
- IP address is in `preferred_ranges` set and is [private ipv4](https://en.wikipedia.org/wiki/IPv4#Private_networks)
- IP address is ipv6
- IP address is public ipv4
- IP address is private ipv4
