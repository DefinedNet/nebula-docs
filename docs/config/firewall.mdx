...
This setting was introduced in Nebula v1.9.0 set to `true` for backwards compatibility purposes. The default was
changed to `false` in Nebula v1.10.0 and the config option is now deprecated.
